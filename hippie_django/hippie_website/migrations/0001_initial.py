# Generated by Django 6.0.2 on 2026-04-09 14:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bait_prey', to='hippie_website.interaction')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uniprot_id', models.CharField(db_index=True, help_text='e.g. "P38398-2"', max_length=20)),
                ('name', models.CharField(blank=True, default='', max_length=100)),
                ('protein', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='isoforms', to='hippie_website.protein')),
            ],
            options={
                'db_table': 'isoform',
            },
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('interaction', 'pmid', 'direction'), name='bait_pray_unique'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name='isoform',
            constraint=models.UniqueConstraint(fields=('protein', 'uniprot_id'), name='isoform_protein_uniprot_unique'),
        ),
        migrations.AddConstraint(
